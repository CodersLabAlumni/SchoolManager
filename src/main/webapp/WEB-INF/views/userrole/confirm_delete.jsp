...
<body>
	...
	<div class="container">
		<c:if test="${empty msg}">
			<h3 class="text-center">Are you sure that for the following
				user:</h3>
			...
			<h3>You want to remove the following user role:</h3>
			...
			<table class="table table-bordered">
				<thead>
					...
					<tr>
						<td><c:out value="${userRoleToDelete.userRole}"></c:out></td>
						<td>Placeholder for school info</td>
					</tr>
			</table>
